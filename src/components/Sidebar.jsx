...
const Sidebar = ({ fetchQuotes }) => {
    ...
    return (
        <div className="relative bg-[#4B2E2B] flex md:flex-col items-center justify-around mt-5 m-auto md:w-20 md:h-80 w-90 rounded-[40px] text-[#FFF8F0] md:m-50 md:mx-10 py-5 shadow-[2px_4px_4px_rgba(0,0,0,0.2)]">
