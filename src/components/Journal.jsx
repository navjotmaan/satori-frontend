...
const Journal = () => {
    ...
    return (
        <div className="px-6 py-14">
            ...
            <svg onClick={toggleDropdown} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="absolute right-10 top-5 lucide lucide-ellipsis-vertical-icon lucide-ellipsis-vertical"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>
            ...
            {dropdownOpen && (
                <div onClick={() => setDropdownOpen(false)} className='absolute top-8 right-15 rounded-lg px-2 flex flex-col items-center justify-center w-20 bg-[#FFF8F0] border border-[#4B2E2B] text-[#4B2E2B]'>
                    <Link to="/new">
                        <button className='rounded-lg py-1 px-3'>Edit</button>
                    </Link>
